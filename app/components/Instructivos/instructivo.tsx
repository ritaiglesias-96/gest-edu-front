        ...
        <AccordionDetails>
          <Typography>
            ...
            <p>
              ...
              correo electrónico, notificación web y mobile.
            </p>
            <hr />
            <div className='flex'>
              <Grading className='h-6 self-center sm:w-auto mr-5' />
            ...
            <p>
              ...
              Ingresando dicho código en la página como invitado, se pueden ver los 
              datos del certificado y comprobar que corresponde al estudiante.
            </p>
            <hr />
            <div className='flex'>
              <DownloadIcon className='h-6 self-center sm:w-auto mr-5' />
      ...
      >
        ...
        <AccordionDetails>
          <Typography>
            ...
            carrras, como a cursos y exámenes. Para ello, se divide en dos
            secciones más.
            <div className='flex'>
